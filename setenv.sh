...
export PORT_GIT_URL="https://git.savannah.gnu.org/git/texinfo.git"
export PORT_GIT_DEPS="git make m4 perl autoconf libtool automake xz"

export PORT_EXTRA_CFLAGS=""
export PORT_EXTRA_LDFLAGS=""

if [ "${PORT_TYPE}x" = "GITx" ]; then
	export PORT_BOOTSTRAP="./autogen.sh"
fi
